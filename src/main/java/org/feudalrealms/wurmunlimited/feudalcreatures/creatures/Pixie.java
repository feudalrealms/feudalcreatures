...
public class Pixie implements ModCreature, CreatureTypes, ItemMaterials, SoundNames {
    ...
    public CreatureTemplateBuilder createCreateTemplateBuilder() {
        ...
        final int[] itemsButchered = {sausageSkin, eye, tooth, bladder, heart, flowerLavender, brandy};
...
//              TYPE, BodyType, Vision, Sex, CentimetersHigh, CentimetersLong, CentimetersWide
                ...
                0.11F, 15.0f, 10.0F, 0.0F, 0.0F, 0.0F, 1.25F, 2500, itemsButchered, 35, 50, MATERIAL_MEAT_HUMAN
        );
