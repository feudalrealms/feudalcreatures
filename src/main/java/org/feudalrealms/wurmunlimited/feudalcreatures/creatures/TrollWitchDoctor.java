...
//        float ogControl = this.baseSkillTree.get(BODY_CONTROL).getNumber();
        ...
        CreatureTemplateBuilder builder = new CreatureTemplateBuilder(
                ...
                "Troll Witch Doctor",
                "Dis wont hurt a bit...","model.creature.humanoid.troll.standard.witchdoctor",
                types, BodyTemplate.TYPE_ETTIN, (short)5, (byte)0, (short)360, (short)20, (short)35,
                "sound.death.troll", "sound.death.troll", "sound.combat.hit.troll", "sound.combat.hit.troll",
                1.0F, 4.0F, 0.0F, 0.0F, 0.0F, 0.0F,
                0.8F, 0, itemsButchered, 8, 40, MATERIAL_MEAT_HUMAN
        );
